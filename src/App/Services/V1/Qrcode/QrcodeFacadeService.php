 ...
 * @LastEditTime: 2026-07-30 04:02:17
 * @FilePath: \youhu-laravel-api-13d:\wwwroot\PHP\Components\Tool\youhujun\php-tool-youhujun\src\App\Services\V1\Qrcode\QrcodeFacadeService.php
 * Copyright (C) 2026 youhujun. All rights reserved.
 */

namespace YouHuJun\Tool\App\Services\V1\Qrcode;
...
#[DocNote('二维码生成服务类 提供二维码生成功能,支持多种输出模式,去除框架和模型依赖')]
class QrcodeFacadeService
{
    ...
    public function makeQrcode(array $config, array $params, int $mode = 1)
    {
        ...
        $noticeInfo = $config['noticeInfo'] ?? 'youhu';

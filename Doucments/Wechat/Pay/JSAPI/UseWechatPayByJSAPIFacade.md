...
$config = [
    ...
    'merchantPrivateKeyPath' => '/path/to/apiclient_key.pem',  // 商户私钥文件路径
    'wechatpayCertificatePath' => '/path/to/wechatpay.pem',     // 微信支付平台证书文件路径
    'officialAppid' => '微信公众号AppId',              // 公众号AppId
...
$config = [
    ...
    'merchantPrivateKeyPath' => '/path/to/apiclient_key.pem',
    'wechatpayCertificatePath' => '/path/to/wechatpay.pem',
    'officialAppid' => 'wx1234567890abcdef',
